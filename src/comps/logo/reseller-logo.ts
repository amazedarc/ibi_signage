...
@Component({
  ...
  template: `
    <img
      ...
      [loadingImage]="'http://smart.ibi-africa.com/ibi2/logo.png'"
      [defaultImage]="'http://smart.ibi-africa.com/ibi2/logo.png'"
      [errorImage]="'http://smart.ibi-africa.com/ibi2/logo.png'"
      [retry]="3"
      [delay]="500"
      (loaded)="_onLoaded()"
      (error)="_onError()"
